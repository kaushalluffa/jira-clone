...
import { OrganizationsSwitcher } from "./organizations-switcher";
import { useAuthSession, useSignOut } from "@/hooks/use-auth-hooks";
...
export function TopNav({
  ...
  return (
    <TooltipProvider>
      <div className="sticky top-0 z-50 h-14 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          ...
          <div className="ml-auto flex items-center gap-1">
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" aria-label="Notifications">
                  <div className="relative">
                    ...
                    {unread > 0 ? (
                      <Badge
                        className="absolute -top-2 -right-2 px-1 py-0 h-4 min-w-4 rounded-full text-[10px]"
                        variant="destructive"
                      >
                        {unread}
                      </Badge>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  onClick={() => alert("Profile is a mock screen")}
                >
                  Profile
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() => alert("Preferences are mocked")}
                >
                  Preferences
                </DropdownMenuItem>
                <DropdownMenuSeparator />
